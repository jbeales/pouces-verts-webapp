<x-layout>
    <section>
        <aside class="notice">
            ...
            <ul>
                <li>Pour les jardins à l'Île-des-Sœurs il faut communiquer avec la Société d'horticulture de l'Île-des-Sœurs</li>
            ...
            <div lang="en-CA">
                ...
                <ul>
                    <li>For the gardens on Île-des-Soeurs please contact the Société d'horticulture de l'Île-des-Soeurs</li>
